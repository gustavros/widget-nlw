...
export function FeedbackContentStep({
  ...
  function handleSubmitFeedback(event: FormEvent) {
    ...
    console.log({
      screenshot,
      comment,
      feedbackType: feedbackTypeInfo.title,
    });
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            ...
            className="p-2 bg-brand-500 rounded-md border-transparent flex-1 justify-center items-center text-sm hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 
